        ...
        <div className="w-full bg-white opacity-75 text-center py-20 mt-12">
            <div className="md:max-w-4xl md:mx-auto">
                ...
                <div className="md:flex md:justify-between mt-5">
                    ...
                    <div>
                        <div className="flex justify-center md:justify-normal mt-12 md:mt-0">
                            <div>
                                <Link to={`https://www.linkedin.com/in/shahadad/`}>
                                    <IoLogoLinkedin className="text-5xl md:mr-3 mr-5  cursor-pointer hover:text-[#0A6BCA]" />
                                </Link>
                            </div>
                            <div>
                                <Link to={`https://github.com/mdshahadad`}>
                                    <IoLogoGithub className="text-5xl md:mr-3 mr-5 cursor-pointer" />
                                </Link>
                            </div>
                            <div>
                                <FaTelegram className="text-5xl md:mr-3 mr-5 cursor-pointer hover:text-[#2a9cd4]" />
                            </div>
                            <div>
                                <FaWhatsapp className="text-5xl md:mr-3 mr-5 cursor-pointer hover:text-[#2bb741]" />
                            </div>
                            <div className="">
                                <TbMailShare className="text-5xl md:mr-3 mr-5 cursor-pointer hover:text-[#ea3f41]" />
                            </div>
                        </div>
                ...
                <div className="mt-12 font-medium text-lg md:text-xl flex justify-center">
