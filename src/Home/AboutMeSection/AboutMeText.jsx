    ...
    return (
        <div className="">
            <div className="z-20 md:hover:z-10 ">
                <img className="absolute bottom-0 right-52 " src="https://i.postimg.cc/c4pMKW73/IMG-2118-1.png" alt="" />
            </div>
            <div className="absolute bottom-56 w-1/3 font-medium text-xl left-[420px]">
                ...
                <div className="">
                    ...
                    <button className="px-10 bg-white opacity-75 hover:opacity-100 font-medium text-black py-5 rounded-lg flex justify-center items-center">
                        Resume
