        ...
        <div className="z-20 md:hover:z-10">
            ...
            <div
                ...
                <div className="">
                    ...
                    <button className="md:px-12 px-10 md:bg-white bg-transparent border-2 md:border-0 opacity-75 hover:opacity-100 font-medium md:text-black text-white md:py-5 py-4 rounded-lg flex justify-center items-center">
                        Resume
