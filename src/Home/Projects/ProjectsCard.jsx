...
const ProjectsCard = () => {
    return (
        <div className=" mt-72 md:w-full md:h-[1900px] max-w-7xl mx-auto">
            <div>
                <div className="container projects-card gap-4 relative w-full">
                    ...
                    <div className="right bg-white opacity-80 px-5 py-10 absolute z-10 rounded-xl">
                ...
                <div className="container projects-card  top-[500px] gap-4 relative w-full">
                ...
                <div className="container projects-card top-[1000px] gap-4 relative w-full">
                ...
                <div className="container projects-card  top-[1500px] gap-4 relative w-full">
            ...
            <div className="flex justify-center">
                <button
                    className="text-black bg-white mt-[1800px] px-14 py-7 rounded-2xl font-medium hover:bg-transparent hover:text-white hover:scale-110  hover:outline-dotted
