    ...
    return (
        <div className="">
            <div className="mb-20">
                ...
                <h3 className="text-white font-medium text-xl md:text-3xl text-center mt-28 md:mt-72 uppercase hover:opacity-100">All your question answer is here</h3>
                <FAQDetails></FAQDetails>
            </div>
            <div>
                <h3 className="text-white font-medium text-2xl md:text-3xl text-center mt-32 uppercase hover:opacity-100">Have more questions?</h3>
