            ...
            <div
                ...
                <div className="md:mt-10 mt-4">
                    ...
                    <button
                        ...
                        className="lg:px-14 md:px-12 px-10 md:bg-white border-2 md:border-0 opacity-75 hover:opacity-100 font-bold md:text-black text-white md:py-5 py-4 rounded-lg flex justify-center items-center
